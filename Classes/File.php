...
// ['master' => 'id'], 'multilingual' => true
//         ['master' => 'title', 'name' => 'section_id', 'notnull' => true],
//         ['master' => 'title', 'name' => 'path'],
//         ['master' => 'title', 'name' => 'path_tab'],
//         ['master' => 'title', 'name' => 'path_mobile']
...
//                                 ],
  ...
  //       ],
   ...
   //                              'project.project.intro'=>['type'=>'textarea'],
   //                              'project.project.description'=>['type'=>'textarea','class'=>'ckeditor'],
   //                              'project.project.title_video',
   //                              'project.project.desc_video'=>['title'=>'Description Video'],
   //                              'project.project.video',
   //                              'project.project.detail_client',
   //                              'project.project.detail_status',
   //                              'project.project.detail_energy',
   //                              'project.project.detail_commisioned',
   //                              'project.project.detail_acquisition',
   //                              'project.project.detail_ppa_expiration',
   //                              'project.project.detail_innergex_participation',
   //                              'project.project.detail_capacity_gross',
   //                              'project.project.detail_capacity_net'
   //                      ]
   //              ],
   ...
   //                              'project.project.description'=>['type'=>'textarea','class'=>'ckeditor'],
   //                              'project.project.title_video',
   //                              'project.project.decs_video'=>['title'=>'Description Video'],
   //                              'project.project.video',
   //                              'project.project.detail_client',
   //                              'project.project.detail_status',
   //                              'project.project.detail_energy',
   ...
   //                      ]
   //              ],
   //              'export'=>['positions'=>'header','permalink'=>true]
   //      ]
